    ...
    <div id="banner" className="bg-white">
      <div className="p-3 mx-5 mt-5 lg:p-4 transition-all bg-[#EFEFED] rounded-[20px] lg:rounded-[40px] relative overflow-hidden">
        ...
        <div className="absolute top-3 lg:top-5 left-1/2 -translate-x-1/2 w-[95%] md:w-5/6 lg:w-4/5 flex justify-between items-center px-2 md:px-0 py-3 lg:py-2">
          <h1 className="text-lg ml-3 sm:text-xl font-bold text-[#263040]">HASNAT</h1>
          <a
        ...
        <div className="mt-20 md:mt-24 lg:mt-28 px-4 md:px-0 w-[95%] md:w-5/6 lg:w-4/5 mx-auto flex flex-col items-center lg:items-start gap-5 md:gap-6 text-center lg:text-left">
              {/* Profile Image */}
          <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-full overflow-hidden border-4 border-white  shadow-md">
            <img
              src="/hasnat.jpg" 
              alt="Md Abul Hasnat Kallol"
              className="w-full h-full  object-cover"
            />
          </div>
          {/* Intro */}
          <div className="text-[#263040] font-bold">
            <div className="text-[18px] sm:text-[22px] lg:text-[28px] font-light">Hello, I'm</div>
          ...
          {/* About Me */}
          <p className="text-[#263040] text-base sm:text-lg leading-relaxed max-w-2xl">
            I’m a dedicated MERN Stack developer with a passion for building clean, responsive, and scalable web applications. I thrive on solving complex problems with efficient code and love collaborating on modern, real-world solutions.
          </p>
